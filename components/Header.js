...
function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 flex items-center md:px-4 py-2 shadow-md bg-white">
            <Button
                color="gray"
                buttonType="outline"
                rounded={true}
            ...
            <div className=" md:mx-20 flex flex-grow items-center md:p-5 py-2
            ...
            <img
             onClick={signOut}
             loading="lazy"
             className="cursor-pointer h-12 w-12 rounded-full md:ml-2 ml-4 mr-2"
